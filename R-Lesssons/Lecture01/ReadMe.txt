...
1. Expand the zip file. One way is to open the zip file
   and drag and drop folder "Lecture01" to a
   convenient location such as your desktop
2. Open the folder "Lecture01"
3. In that folder, double click on the file "Lec01Start.Rproj"
...
3. Select the file PubH6002_0.20.tar.gz
