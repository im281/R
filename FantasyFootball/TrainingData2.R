...
finalfinal <- merge(finaltable,d,all = TRUE)
#Assign 0 to NAs
finalfinal[is.na(finalfinal)] <- 0

#finalfinal <- unique(finalfinal)

write.csv(finalfinal,'W5_TrainingData1.csv')
UploadToMLStudio(finalfinal,'W5_TrainingData1.csv')
