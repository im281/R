...
#subset the players table so that it only contains the names of the players for the
#game you want to predict FP
##################################################################################################
...
#Get only the players that are in this upcoming game
...
test <- fd[which(!is.na(fd$FD.points))]
